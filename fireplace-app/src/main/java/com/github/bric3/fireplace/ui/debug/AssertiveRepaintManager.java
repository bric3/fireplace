...
public final class AssertiveRepaintManager extends RepaintManager {
  ...
  public AssertiveRepaintManager() {
    ...
    try {
      ...
      System.out.println("Could not set bufferingStrategy for AssertiveRepaintManager" + e);
    }
  }
  ...
  private void checkThreadViolations(Component c) {
    if (!SwingUtilities.isEventDispatchThread() && (c == null || c.isShowing())) {
      ...
      String categoriesString = System.getProperty("non.edt.swing.report.categories");
  ...
  private boolean isAllowedViolation(Component c, StackTraceElement[] stackTrace) {
