...
class Hud(private val mainComponent: JComponent) {
    private val backgroundPainter = Painter.compose(
        Painter.blurOf(mainComponent),
        Painter.translucent()
    )

    private val dndPanel: JPanel = JPanelWithPainter(
        GridBagLayout(),
        backgroundPainter
    ).apply {
    ...
    private val progressPanel: JPanel = JPanelWithPainter(
        BorderLayout(),
        backgroundPainter
    ).apply {
        add(
